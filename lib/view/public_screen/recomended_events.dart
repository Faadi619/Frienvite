...
class RecomendedEventsScreen extends StatefulWidget {
  const RecomendedEventsScreen({super.key});

  @override
  State<RecomendedEventsScreen> createState() => _RecomendedEventsScreenState();
}

class _RecomendedEventsScreenState extends State<RecomendedEventsScreen> {
          ...
          child: DefaultTabController(
            ...
            child: Column(
              children: [
                ...
                SizedBox(child: UpcomingPolls(categories: categories)),
              ],
            ),
          ),
        ),
            ...
            child: CustomContainer(
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    previousPage.setPreviousPage(nearbyevent);
