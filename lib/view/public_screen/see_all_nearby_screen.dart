...
class SeeAllNearByEvents extends StatefulWidget {
  const SeeAllNearByEvents({super.key});

  @override
  State<SeeAllNearByEvents> createState() => _SeeAllNearByEventsState();
}

class _SeeAllNearByEventsState extends State<SeeAllNearByEvents> {
